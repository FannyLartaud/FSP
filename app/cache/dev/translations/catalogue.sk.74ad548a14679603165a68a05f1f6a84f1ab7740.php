...
$catalogue = new MessageCatalogue('sk', array (
  ...
  'message' => 
  array (
    'translations.invalidate_cache' => 'Zrušiť vyrovnávaciu pamäť',
    'translations.domain' => 'Doména',
    'translations.key' => 'Kľúč',
    'translations.grid_caption' => 'Zoznam prekladov',
    'translations.cache_removed' => 'Súbory vyrovnávacej pamäte boli odstránené',
    'translations.new_translation' => 'Nový preklad',
    'translations.add_translation' => 'Pridaj preklad',
    'translations.save' => 'Uložiť',
    'translations.save_add' => 'Uložiť a pridať',
    'translations.page_title' => 'Preklady',
    'translations.show_hide_columns' => 'Skryť/odkryť stĺpce',
    'translations.toggle_all_columns' => 'Skryť/odkryť stĺpce',
    'translations.save_row' => 'Uložiť aktuálny riadok',
    'translations.succesfully_updated' => 'Preklad pre kľúč #%id% bol úspešne zaktualizovaný.',
    'translations.succesfully_added' => 'Preklad bol úspešne pridaný.',
    'translations.update_failed' => 'Zlyhala aktualizácia prekladu pre kľúč #%id%.',
    'translations.back_to_list' => 'Späť',
    'translations.all_translations' => 'Všetko',
    'translations.no_translations' => 'Žiadny preklad',
    'translations.profiler' => 'Profiler',
    'translations.data_source' => 'Zdroj údajov',
    'translations.latest_profiles' => 'Posledné profily',
    'translations.profile' => 'Profil',
    'overview.page_title' => 'Prehľad',
    'overview.show_grid' => 'Prekladateľská šablóna',
    'overview.msg_latest_translation' => 'Posledný preklad z %date% UTC.',
    'overview.domain' => 'Doména',
    'overview.no_stats' => 'Žiadne údaje na zobrazenie.',
  ),
));
...
$catalogueFr = new MessageCatalogue('fr', array (
  ...
  array (
    ...
    'translations.successfully_added' => 'Traduction ajouté avec succès.',
    'translations.successfully_deleted' => 'Traduction supprimé avec succès.',
    'translations.update_failed' => 'Erreur lors de la mise à jour des traductions pour clé #%id%.',
    'translations.delete_failed' => 'Erreur lors de la supression pour la clé #%id%.',
    'translations.back_to_list' => 'Retour',
    'translations.all_translations' => 'Tout',
    'translations.no_translations' => 'Aucune traduction',
    'translations.profiler' => 'Profileur',
    'translations.data_source' => 'Source de donnée',
